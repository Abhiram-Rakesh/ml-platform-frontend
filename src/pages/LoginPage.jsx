...
import { Cpu, Eye, EyeOff, Github } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          {error && (
            <div className="mt-4 bg-red-50 text-red-700 text-sm px-4 py-3 rounded-md">
              {error}
            </div>
          )}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-md border border-gray-300 px-3 py-2 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
                <button
                  type="button"
